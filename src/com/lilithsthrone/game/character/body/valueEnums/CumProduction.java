...
enum CumProduction {
	...
	SIX_EXTREME("extreme",
	            ...
	            1000,
	            0,
	            Wetness.SIX_SOPPING_WET,
	            PresetColour.GENERIC_SIZE_SEVEN,
	            4),

	/**
	 * This and SIX_EXTREME are a bit ridiculous, and should only be used as part of "extreme proportion" content.
	 */
	SEVEN_MONSTROUS("monstrous",
	                "a monstrous amount of",
	                1000,
	                10000,
	                0,
	                Wetness.SEVEN_DROOLING,
	                PresetColour.GENERIC_SIZE_EIGHT,
	                8);
	...
	public
	int getArousalNeededToStartPreCumming() {
		return arousalNeededToStartPreCumming;
	}

	public static
	CumProduction getCumProductionFromInt(int cumProduction) {
		for (CumProduction cp : values()) {
			if (cumProduction >=
			    cp.minimumValue &&
			    cumProduction <
			    cp.maximumValue) {
	 ...
	 */
	public
	int getAdditionalSlotsDirtiedUponOrgasm() {
