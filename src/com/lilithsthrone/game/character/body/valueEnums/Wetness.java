...
public enum Wetness {
	...
	ZERO_DRY("dry",
	         ...
	         101,
	         101,
	         PresetColour.GENERIC_WETNESS_ONE),
	
	ONE_SLIGHTLY_MOIST("slightly moist",
	                   1,
	                   100,
	                   101,
	                   PresetColour.GENERIC_WETNESS_TWO),
	
	TWO_MOIST("moist",
	          2,
	          80,
	          95,
	          PresetColour.GENERIC_WETNESS_THREE),
	
	THREE_WET("wet",
	          3,
	          50,
	          90,
	          PresetColour.GENERIC_WETNESS_FOUR),
	
	FOUR_SLIMY("slimy",
	           4,
	           30,
	           80,
	           PresetColour.GENERIC_WETNESS_FIVE),
	
	FIVE_SLOPPY("sloppy",
	            5,
	            10,
	            70,
	            PresetColour.GENERIC_WETNESS_SIX),
	
	SIX_SOPPING_WET("sopping wet",
	                6,
	                0,
	                60,
	                PresetColour.GENERIC_WETNESS_SEVEN),
	
	SEVEN_DROOLING("drooling",
	               7,
	               0,
	               50,
	               PresetColour.GENERIC_WETNESS_EIGHT);
