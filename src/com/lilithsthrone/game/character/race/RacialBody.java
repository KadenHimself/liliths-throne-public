...
public class RacialBody {
	...
	public static AbstractRacialBody HUMAN = new AbstractRacialBody(
			...
			OrificeDepth.TWO_AVERAGE,
			OrificeElasticity.THREE_FLEXIBLE,
			OrificePlasticity.THREE_RESILIENT,
			BreastType.HUMAN, BreastShape.getNonUdderBreastShapes(),
			CupSize.FLAT,
			1,
			Lactation.ZERO_NONE,
			Capacity.ZERO_IMPENETRABLE,
			OrificeDepth.TWO_AVERAGE, OrificeElasticity.THREE_FLEXIBLE,
			OrificePlasticity.THREE_RESILIENT,
				NippleSize.ZERO_TINY,
			NippleShape.NORMAL,
			AreolaeSize.ZERO_TINY,
			1,
			CupSize.C,
			1,
			Lactation.ZERO_NONE,
			...
			180, 50, BodySize.ONE_SLENDER.getMedianValue(), Muscle.ZERO_SOFT.getMedianValue(),
			170, 75, BodySize.THREE_LARGE.getMinimumValue(), Muscle.ONE_LIGHTLY_MUSCLED.getMinimumValue(),
			EarType.HUMAN,
			EyeType.HUMAN,
			...
			PenisType.HUMAN, 5, PenetrationGirth.ONE_SLENDER, TesticleSize.ONE_TINY, 2, CumProduction.ZERO_NONE,
	...
	public static AbstractRacialBody HORSE_MORPH = new AbstractRacialBody(
			...
			PenisType.EQUINE, 30, PenetrationGirth.FIVE_THICK, TesticleSize.FOUR_HUGE, 2, CumProduction.FIVE_HUGE, Util.newArrayListOfValues(TailType.HORSE_MORPH),
			TentacleType.NONE,
